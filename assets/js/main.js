    ...
    function addActiveClassToCurrentSection() {
        ...
        navLinks.forEach(link => {
            if (link.getAttribute('href').substring(1) === currentSectionId) {
                link.classList.add('active'); // <-- This line adds the 'active' class to the current section's link
            }
        });
    }

    // Add scroll event listener to window
    window.addEventListener('scroll', addActiveClassToCurrentSection); // <-- This line ensures the function is called on scroll
